...
for m = 1:numel(model_types)
    ...
    output_dirname = [pwd(), '\results_2023_08_11_s6\', eff_dist_label '\' ];
    ...
    % For revised version, looking only at a subset of mu values. 
    % note that these have also been synced with
    % "main_LogitNormal_mean_Eff.m"
    mu_1 = -3;
    d_mu = 1;
    mu_f = 0;
    ...
    Eff_mat_fname = ['Eff_mean_mu_vs_sig_R1_s6.csv'];
